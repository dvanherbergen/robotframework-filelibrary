...
public class FileUtilTest {
	...
	@Test
	public void canTransformFileWithoutThrowingException() {
		FileUtil.xsltTransfrom("src/test/resources/FileUtil/article.xml", "src/test/resources/FileUtil/article.xslt", "target/result.xml");
	}
}
